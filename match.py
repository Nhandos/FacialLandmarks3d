...
def main(args):
    ...
    roi2 = facedetector(img2, profile='side')

    kp1, des1, _ = extractor(img1, roi1)
    kp2, des2, _ = extractor(img2, roi2)
    matches, mask = matcher(kp1, des1, kp2, des2, loweratio=0.9)
    ...
    img3 = cv2.drawMatchesKnn(img1,kp1,img2,kp2,matches,None,
        flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS, matchesMask=mask)
